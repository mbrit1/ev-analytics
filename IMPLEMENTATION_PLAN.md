...
- [ ] Install and configure dependencies (Tailwind, PWA, Supabase, Dexie, TanStack Query)
- [ ] Set up project structure (features folder)
- [ ] Basic configuration (Vite, Tailwind, PWA manifest)
- [ ] Create ADRs: `001-react-spa.md`, `002-dexie-offline-first.md`, `003-cloudflare-pages.md`
