...
BEGIN
    ...
    INSERT INTO charging_sessions (
        ...
        NULL,
        NULL,
        '{"cpoName":"TEAG","pricePerKwh":79,"priceCapturedFrom":"receipt"}'::jsonb,
        79,
        0,
    ...
    -- Ad-hoc charging session where the physical operator is unknown.
    INSERT INTO charging_sessions (
        id,
        user_id,
        session_timestamp,
        ...
        NULL,
        NULL,
        '{"cpoName":null,"pricePerKwh":65,"priceCapturedFrom":"receipt"}'::jsonb,
        65,
        0,
        'Ad-hoc entry with unknown charging-station operator.'
    )
    ON CONFLICT (id) DO UPDATE
      SET user_id = EXCLUDED.user_id,
          session_timestamp = EXCLUDED.session_timestamp,
